...
O Windows não está vendo pedaleira nenhuma: ela está desligada, o cabo é só de carga, ou está num hub. Use o cabo que veio na caixa, ligue direto numa porta do PC, confira que a pedaleira está ligada (em modo normal ou na tela *Firmware Update / Restore*, tanto faz) e rode de novo.
